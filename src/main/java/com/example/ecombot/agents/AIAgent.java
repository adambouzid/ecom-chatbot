package com.example.ecombot.agents;
...
public class AIAgent {
    ...
    public AIAgent(ChatClient.Builder builder, ChatMemory memory , ToolCallbackProvider tools) {
        ...
        this.chatClient = builder
                .defaultSystem("Vous ete un assistant qui se charge de repondre aux question de lutilisateur en fonction du contexte fourni et si li ya pas de context repond par je ne sait pas.")
